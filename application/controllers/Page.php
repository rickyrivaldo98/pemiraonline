...
class Page extends CI_Controller
{
	...
	public function hasilvote()
	{
		...
		$data['pemenang'] = $this->m_calonketuabemf->getPemenang();
	...
	public function log()
	{
		...
		$suara_Biologi = (int)$suara_Biologi['jumlah'];
		$suara_Bioteknologi = (int)$suara_Bioteknologi['jumlah'];
		$suara_Kimia = (int)$suara_Kimia['jumlah'];
		$suara_Fisika = (int)$suara_Fisika['jumlah'];
		$suara_Statistika = (int)$suara_Statistika['jumlah'];
		$suara_Matematika = (int)$suara_Matematika['jumlah'];
		$suara_Informatika = (int)$suara_Informatika['jumlah'];
		...
		$data['suara_terpakai'] = (int)$jumlah_suara / (int)$total_suara_pemilih * 100;
	...
	public function printLog()
	{
		...
		//total suara masuk
		$data['jumlah_pemilih'] = (int)$this->m_logsuara->countLog()['jumlah'];

		//total suara pemilih
		$suara_Biologi = (int)$this->m_logsuara->countBiologi()['jumlah'];
		$suara_Bioteknologi = (int)$this->m_logsuara->countBioteknologi()['jumlah'];
		$suara_Kimia = (int)$this->m_logsuara->countKimia()['jumlah'];
		$suara_Fisika = (int)$this->m_logsuara->countFisika()['jumlah'];
		$suara_Statistika = (int)$this->m_logsuara->countStatistika()['jumlah'];
		$suara_Matematika = (int)$this->m_logsuara->countMatematika()['jumlah'];
		$suara_Informatika = (int)$this->m_logsuara->countInformatika()['jumlah'];
