            ...
            <div class="row justify-content-center">
                <?php foreach ($pemenang as $p) { ?>
                    <label class="col-12 col-md-4 text-center order-2 order-md-1">
                        <h2>Selamat Kepada Ketua BEM Terpilih</h2>
                        <div class="card ">
                            <img class="gambar_voting mx-auto d-block" src="<?php echo base_url() . 'calon/' . $p['foto'] ?>" alt="">
                            <!-- <h2>CALON <?= $i; ?></h2> -->
                            <h6>Ketua : <?= $p['nama_ketua']; ?></h6>
                            <h6>Wakil Ketua : <?= $p['nama_wakil']; ?></h6>
                            <h3>Dengan Jumlah Total Suara: <?= $p['suara']; ?> Suara</h3>
                            <!-- <h3><?= (int)$p['suara'] / (int)$p['total'] * 100; ?> %</h3> -->
                        </div>
                    </label>
                <?php } ?>
            </div>
            <h2 class="text-center mt-3 mb-3">Hasil Voting Keseluruhan</h2>
            <div class="row justify-content-center">
                <?php
                if ($calon) :
                    $i = 1;
                ...
                ?>
                        <label class="col-12 col-md-4 text-center order-2 order-md-1">
                            <div class="card ">
                                ...
                                <h3><?= (int)$row['suara'] / (int)$suara['total'] * 100; ?> %</h3>
                            </div>
                        </label>
                <?php
                        $i++;
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?php
                            if (count($calon) > 0) {
                                foreach ($calon as $row) {
                                    echo "'" . (int)$row['suara'] / (int)$suara['total'] * 100 . "',";
                                }
                            }
                            ?>],
                    backgroundColor: [
